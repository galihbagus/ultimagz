      ...
      <div>
            ...
            <li style="width:120px">&nbsp;</li>
             ...
             <li style="width:80px; padding:0;">
             	<a href="regist_user.php" target="_self" ><img src="images/register.gif" width="80px" height="25px" /></a>
             </li>
             <?php } else{?>
             ...
             <li><a style="padding:0;" href="logout.php" target="_self" ><img src="images/signout.gif" width="80px" height="25px" /></a></li>
			 <?php }?>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <?php
		$sql="SELECT * FROM artikel where judul like '%$keyword%'";
	...
	<?php
        ...
        //cetak isi artikel
	echo $row['isi'];
	echo "<br><a href='show.php?id=".$row['IDartikel']."'>Read More</a>"
	?>
    </div>
    <?php
}
