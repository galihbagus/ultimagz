	...
	while($row = mysql_fetch_array($result))
	 {
       ...
       // <div class="article">
		...
		echo "<div class=\"article\">
						...
						<p>".$row['isi']."</p>
						<p><a href='show.php?id=".$row['IDartikel']."'><strong>Comments ($countcom)</strong></a> <span>&nbsp;&bull;&nbsp;
						</span>".$row['tanggal']."<span>&nbsp;&bull;&nbsp;</span></a></p>
						</div>			";	
	/*echo "<a href='show.php?id=".$row['IDartikel']."'><h3><span>".$row['judul']."</span></h3></a> <br><br>
       
        <p class=\"infopost\">Posted by <a href=\"#\">Admin</a> &nbsp;&nbsp;|&nbsp;&nbsp; Category <a href=\"#\">".$row['kategori']."</a>
		<a href=\"#\" class=\"com\"></a></p>";*/
