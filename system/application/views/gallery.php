...
<title>Gallery</title>
<link rel="stylesheet" href="<?php echo base_url() ?>/gallery/css/basic.css" type="text/css" />
<link rel="stylesheet" href="<?php echo base_url() ?>/gallery/css/galleriffic-2.css" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url() ?>/gallery/js/jquery-1.3.2.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>/gallery/js/jquery.galleriffic.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>/gallery/js/jquery.opacityrollover.js"></script>
