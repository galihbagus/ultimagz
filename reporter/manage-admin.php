  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2><span>Manage Artikel</span></h2>
          ...
          <div class="clr"></div>
			...
			<?php
				...
				echo "<tr><td><h3>Judul Artikel</h3></td>";
				echo "<td><h4>Author</h4></td>";
				echo "<td><a href=#>[approve]</a></td>";
				echo "<td><a href=#>[view]</a></td>";
				echo "<td><a href=#>[decline]</a></td>";
				echo "</tr>";
			?>
            </table>
        </div>
        <div class="article">
          <h2><span>Manage Foto</span></h2>
          
          <div class="clr"></div>
            <br><br>
            <table>
			<?php
		  		echo "<tr><td colspan = \"2\">Title</td><td colspan = \"2\">Author</td></tr>";
				echo "<tr><td rowspan = \"2\"><img src=\"images/gal1.jpg\" width=\"75\" height=\"75\" alt=\"\" class=\"gal\" title=\"title\"/></td>";
				echo "<td><a href=#>[approve]</a></td>";
				echo "<td><a href=#>[view]</a></td>";
				echo "<td><a href=#>[decline]</a></td>";
				echo "</tr>";
